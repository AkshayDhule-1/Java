...
//				double value = Math.random()%10;
				...
				System.out.println(modelName+" WM is "+i);
				try {
					Thread.sleep(1000);
				} catch (InterruptedException e) {
					// TODO Auto-generated catch block
				...
				if(value ==0) {
					PowerCutOffException ex3 = new PowerCutOffException("Power Cutt Off...");
					throw ex3;
				}
				
				if(value>70) {
					VoltageExceedsException ex4 = new VoltageExceedsException("Voltage Exceeds...");
					throw ex4;
				}
